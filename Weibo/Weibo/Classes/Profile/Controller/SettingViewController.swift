...
class SettingViewController: UIViewController {
    ...
    fileprivate lazy var logoffButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(logoff), for: UIControl.Event.touchUpInside)
        button.setTitle("退出当前账号", for: UIControl.State.normal)
        button.setTitleColor(RGB(r: 209, g: 82, b: 94), for: UIControl.State.normal)
